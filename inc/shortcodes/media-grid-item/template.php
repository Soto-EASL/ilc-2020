 ...
 * @var $el_id
 * @var $css_class
 * Shortcode class ILC_Media_Grid_Item
 * @var $this ILC_Media_Grid_Item
 */
...
$css_class .= ' ilc-media-grid-item ilc-media-grid-item-' . $type;
...
$lightbox_gallery_id = 'ilc-lb-gallery-' . ILC_Media_Grid::get_ILC_instance_count();
...
if ( $data_ok ) :
    ILC_Media_Grid::$count_items ++;
    ?>
    <div <?php echo implode( ' ', $wrapper_attributes ); ?>>
        <div class="ilc-media-grid-item-inner">
            <a class="ilc-media-grid-item-link" href="<?php echo $link_href; ?>" data-fancybox="<?php echo $lightbox_gallery_id; ?>">
