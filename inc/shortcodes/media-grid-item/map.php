...
return array(
	'name'           => __( 'ILC Media Grid Item', 'ilc' ),
	'base'           => 'ilc_media_grid_item',
	'as_child'       => array(
		'only' => 'ilc_media_grid',
	),
	'category'       => __( 'ILC', 'ilc' ),
	'description'    => __( 'Add a photo/video', 'ilc' ),
	'icon'           => 'vcex-icon ticon ticon-camera',
	'php_class_name' => 'ILC_Media_Grid_Item',
	'params'         => array(
		array(
			'type'        => 'textfield',
