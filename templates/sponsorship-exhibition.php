<?php
/**
 * Template Name: Sponsorship & Exhibition
 */
		...
		<div id="primary" class="content-area clr">
			...
			<div id="content" class="site-content clr">
				...
				<article id="single-blocks" class="single-page-article wpex-clr">
					...
					<?php endif; ?>
					<div class="ilc-flex-row">
						<div class="ilc-flex-col ilc-spex-menu-container">
							<div class="spex-menu-mobile-tray">
								<span class="spex-menu-mobile-trigger"></span>
								<p class="spex-menu-mobile-text"></p>
							</div>
							<nav class="ilc-spex-menu">
								<?php 
								wp_nav_menu(
									array(
										'theme_location' => 'sponsors-exhibition',
										'depth'			 => 1,
										'container'		 => '',
										'menu_class'	 => 'menu-spex',
										'link_before'	 => '',
										'link_after'	 => '',
										'fallback_cb'	 => '',
									)
						...
						<div class="ilc-flex-col ilc-spex-content-container">
